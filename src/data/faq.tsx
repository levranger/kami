    ...
    questions: [
      {
        ...
        a: "You can book online at https://booking.mangomint.com/757197 or call us at (954) 469-7153.",
        node: <>You can <a href="https://booking.mangomint.com/757197" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-dark underline underline-offset-2 transition-colors duration-150">book online</a> or call us at <a href="tel:+19544697153" className="text-gold hover:text-gold-dark underline underline-offset-2 transition-colors duration-150">(954) 469-7153</a>.</>,
      },
      {
