...
export const botoxCostBodyMeta = {
...
export const botoxCostBody = (
  <>
    ...
    <h2>What Is the Average Cost of Botox?</h2>
    ...
    <h3>Cost Per Unit vs. Cost Per Area</h3>
    ...
    <h3>Typical Price Ranges by Treatment Zone</h3>
    ...
    <h2>What Makes Botox Prices Go Up or Down?</h2>
    ...
    <h2>How Many Units Will You Actually Need?</h2>

    <p>
      Unit count is one of the most important factors in your total cost and one of the most commonly misrepresented.
    </p>

    <h3>Units by Treatment Area</h3>

    <p>
      As a general clinical reference, the following ranges reflect typical usage for most patients. Forehead lines: 10 to 20 units. Glabella or frown lines: 20 to 25 units. Crow's feet: 10 to 15 units per side. Brow lift: 2 to 5 units. Lip flip: 4 to 6 units. Masseter reduction: 25 to 50 units per side. These figures are starting points, not fixed prescriptions.
    </p>
    ...
    <h2>Botox Cost vs. Long-Term Value</h2>

    <h3>How Often Will You Need to Repeat It?</h3>
    ...
    <p>
      The <a href="https://www.plasticsurgery.org/cosmetic-procedures/botulinum-toxin" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-dark transition-colors">American Society of Plastic Surgeons</a> notes that Botox remains one of the most performed non-surgical cosmetic procedures in the country year after year, reflecting both its effectiveness and the satisfaction patients experience with consistent treatment.
    </p>

    <h3>Comparing Botox to Other Anti-Aging Options</h3>
    ...
    <h2>What Should Be Included at That Price?</h2>
    ...
    <p>
      At <Link href="/" className="text-gold hover:text-gold-dark transition-colors">Kami Aesthetics</Link>, every Botox appointment begins with an individualized assessment of facial structure and movement before any treatment is administered. This is not a formality. It is what separates a result that looks natural and intentional from one that looks done.
    </p>
    ...
    <h2>Red Flags When a Botox Quote Seems Too Cheap</h2>

    <p>
      Botox priced significantly below the market average is almost always cheaper for a reason. The most common explanations include diluted product, meaning more saline has been added to stretch fewer units further; underdosing, where a full treatment price covers fewer units than you actually need; unqualified injectors operating outside appropriate medical supervision; or counterfeit product, which while less common is a documented risk in unregulated settings.
    </p>

    <p>
      A <a href="https://pubmed.ncbi.nlm.nih.gov/39616095/" target="_blank" rel="noopener noreferrer" className="text-gold hover:text-gold-dark transition-colors">study published on PubMed examining botulinum toxin complications</a> found that adverse outcomes are significantly more common in non-medical settings and with less experienced injectors, reinforcing the clinical case for choosing a qualified provider over a discounted one.
    </p>
    ...
    <h2>Is Botox Worth the Cost? Who Benefits Most</h2>

    <p>
      <Link href="/services/injectables/botox" className="text-gold hover:text-gold-dark transition-colors">Botox</Link> delivers the clearest return for patients who have dynamic lines they feel self-conscious about, who want a refreshed appearance without surgery or significant downtime, and who understand it as a maintenance commitment rather than a one-time fix.
    </p>
