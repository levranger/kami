...
export const laserHairRemovalPCOSBody = (
  <>
    ...
    <p>
      ...
      examining laser treatment for hirsutism in PCOS, laser hair removal is one of the most effective interventions for PCOS-related hair growth, particularly when combined with appropriate medical management of the underlying hormonal condition.
    </p>
    ...
    <p>
      ...
      as one of the most genuinely helpful treatments they have pursued.
    </p>
    ...
    <div className="bg-warm-white border border-warm-border rounded-sm p-6 my-8">
      <p className="font-inter text-sm font-semibold text-[#1A1A1A] mb-1">Managing PCOS hair growth?</p>
      <p className="font-inter text-sm text-warm-gray">
        Book a free consultation at Kami Aesthetics in Aventura. We&apos;ll assess your specific situation and build a realistic{" "}
        <Link href="/services/lasers/laser-hair-removal" className="text-gold hover:text-gold-dark transition-colors">
          laser hair removal plan
        </Link>{" "}
        around your hormonal profile and goals.
      </p>
    </div>
  </>
);
