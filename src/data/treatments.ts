...
export const treatments: Treatment[] = [
  ...
  },
  {
    ...
    fullDescription:
      "IV therapy is a medical service in which fluids and selected nutrients are administered intravenously after an individual evaluation. At Kami Aesthetics, your goals begin the conversation, while an authorized provider determines whether treatment is appropriate and selects the formulation and dosing for you.",
    heroImage: "/images/services/iv-therapy/iv-therapy-hero.webp",
    heroImageAlt: "Client relaxing during an IV therapy appointment",
    heroImagePosition: "70% center",
    heroGradient: "from-[#1A2A1A]/85 via-[#1A2A1A]/60 to-[#1A2A1A]/30",
    heroEyebrow: "Aventura, Florida",
    heroH1: "IV Therapy in Aventura, FL",
    heroDescription:
      "Explore provider-guided IV options featuring hydration, vitamins, minerals, amino acids, and antioxidant-focused ingredients. Every infusion requires an individual evaluation and provider authorization.",
    heroCtaLabel: "Request an IV Consultation",
    heroStats: [
      { icon: "duration", label: "Duration", value: "Approximately 45–60 minutes" },
      { icon: "evaluation", label: "Evaluation", value: "Required" },
      { icon: "formulation", label: "Formulation", value: "Individualized" },
      { icon: "administration", label: "Administration", value: "Provider-directed" },
    ],
    aboutHeading: "Personalized IV Therapy at Kami Aesthetics",
    benefitsHeading: "Why Clients Choose Kami",
    sidebarCtaSubtext: "Request your IV therapy consultation today.",
    hideTreatmentAreas: true,
    duration: "45–60 min",
    downtime: "None",
    resultsTimeline: "Varies by client and provider evaluation",
    sessionsNeeded: "Determined by provider",
    benefits: [
      "Individual provider assessment",
      "Formulation selected for each eligible client",
      "Multiple vitamin, mineral, amino-acid, and antioxidant-focused options",
      "Relaxing boutique setting in Aventura",
      "Clinical administration according to established protocols",
    ],
    areas: [],
    faq: [
      {
        q: "How is IV therapy different from taking supplements?",
        a: "IV therapy delivers fluids and selected nutrients directly into the bloodstream, bypassing digestion. Whether IV therapy is appropriate for you is determined by a provider during an individual evaluation.",
      },
      {
        q: "How long does an IV session take?",
        a: "Most IV sessions take approximately 45–60 minutes, depending on the formulation selected by your provider.",
      },
      {
        q: "How often should I get IV therapy?",
        a: "Frequency is determined on a case-by-case basis by your provider, based on your evaluation, goals, and clinical judgment.",
      },
    ],
    uniqueSections: [
      {
        type: "iv-menu",
        title: "The IV Menu",
        subtitle: "Provider-guided formulations, grouped by focus area. Availability is confirmed at your evaluation.",
      },
      {
        type: "what-to-expect",
        title: "What to Expect",
        subtitle: "A guided, evaluation-first process from arrival to aftercare",
        image: "/images/services/iv-therapy/iv-therapy-experience.webp",
        imageAlt: "Client receiving an IV infusion in a relaxing treatment setting",
        items: [
          { label: "Clinical Review", description: "An authorized provider reviews relevant health information, current medications, allergies, and treatment goals to determine eligibility." },
          { label: "Personalized Plan", description: "If treatment is appropriate, the provider selects the formulation and dosing based on clinical judgment." },
          { label: "Infusion", description: "An appropriately licensed clinician administers and monitors the infusion according to clinic protocols." },
          { label: "Aftercare", description: "You receive individualized aftercare guidance. Experiences and responses vary between clients." },
        ],
      },
      {
        type: "disclaimer",
        ...
        content:
          "IV therapy is a medical service and requires provider evaluation. Eligibility, formulation, ingredients, and dosing are individualized. Results and experiences vary. Information on this page is educational and is not a substitute for medical advice.",
      },
    ],
  },
  {
