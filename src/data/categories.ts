...
export const categoryDefs: CategoryDef[] = [
  {
    ...
    serviceSlugs: ["laser-hair-removal", "arm-hair-removal", "back-hair-removal", "bikini-hair-removal", "chest-hair-removal", "ear-hair-removal", "eyebrow-hair-removal", "facial-hair-removal", "leg-hair-removal", "upper-lip-hair-removal", "neck-hair-removal", "stomach-hair-removal", "underarm-hair-removal", "laser-hair-removal-dark-skin", "ipl-treatments", "resurfx"],
  },
  {
    slug: "injectables",
...
export const SLUG_TO_CATEGORY: Record<string, CategorySlug> = {
  ...
  "chest-hair-removal": "lasers",
  "ear-hair-removal": "lasers",
  "eyebrow-hair-removal": "lasers",
  "facial-hair-removal": "lasers",
  "leg-hair-removal": "lasers",
  "upper-lip-hair-removal": "lasers",
  "neck-hair-removal": "lasers",
  "stomach-hair-removal": "lasers",
  "underarm-hair-removal": "lasers",
  "laser-hair-removal-dark-skin": "lasers",
